package com.ablez.jookbiren.episode3.quiz.controller;
...
import com.ablez.jookbiren.episode3.quiz.service.Ep3QuizService;
...
@RequestMapping("/ep3/quizzes")
@Slf4j
public class Ep3QuizController {
    private final Ep3QuizService quizService;
