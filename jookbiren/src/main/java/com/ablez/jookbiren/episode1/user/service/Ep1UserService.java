...
import com.ablez.jookbiren.episode1.user.repository.Ep1UserQuerydslRepository;
import com.ablez.jookbiren.episode1.user.repository.Ep1UserRepository;
...
@Service
@Transactional
public class Ep1UserService {
    private final Ep1UserRepository userRepository;
    private final Ep1UserQuerydslRepository userQuerydslRepository;
