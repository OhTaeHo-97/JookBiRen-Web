...
import com.ablez.jookbiren.episode2.user.repository.Ep2UserQuerydslRepository;
import com.ablez.jookbiren.episode2.user.repository.Ep2UserRepository;
...
@Service
@Transactional
public class Ep2UserService {
    private static final int EXCEL_COLUMN_LENGTH = 10;

    private final Ep2UserRepository userJpaRepository;
    private final UserInfoService userInfoService;
    private final JwtTokenizer jwtTokenizer;
    private final Ep2UserQuerydslRepository userRepository;
