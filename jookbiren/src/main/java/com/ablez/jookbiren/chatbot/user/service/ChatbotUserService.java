...
import com.ablez.jookbiren.chatbot.user.repository.ChatbotUserQuerydslRepository;
import com.ablez.jookbiren.chatbot.user.repository.ChatbotUserRepository;
...
public class ChatbotUserService {
    private final ChatbotUserQuerydslRepository userQuerydslRepository;
    private final ChatbotUserRepository userRepository;
